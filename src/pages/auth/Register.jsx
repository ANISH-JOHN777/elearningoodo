        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3 px-5 bg-gradient-to-r from-cyan-400 to-sky-500 text-slate-950 text-sm font-semibold whitespace-nowrap rounded-xl hover:shadow-lg hover:shadow-cyan-400/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all text-gray-700 text-sm font-medium whitespace-nowrap">
            ...
            <button className="flex items-center justify-center gap-2 py-2.5 px-4 bg-gray-900 rounded-xl hover:bg-gray-800 transition-all text-white text-sm font-medium whitespace-nowrap">
